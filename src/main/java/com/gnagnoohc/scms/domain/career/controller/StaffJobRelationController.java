 ...
 * <ul>
 *   <li>교직원({@code ST100}) 및 총괄 관리자({@code AD100}) 권한 보유자만 접근 가능</li>
 * </ul>
 *
 * @author YUN
 */
...
public class StaffJobRelationController {
    ...
    public ApiResponse<PageResponse<JobRelationResponseDTO>> getApplicantsByJobPosting(
        ...
        PageResponse<JobRelationResponseDTO> response = relationService.getApplicantsByJobPosting(jobPostingId, applicationStatus, pageable);
