 ...
 *   <li><b>검수 상태 (reviewStatus):</b> 관리자 검수 단계 필터 (REQUESTED: 검수대기, APPROVED: 승인, REJECTED: 반려)</li>
 *   <li><b>게시 상태 (postingStatus):</b> 공고 게시 라이프사이클 필터 (PUBLISHED: 게시, CLOSED: 마감, DRAFT: 대기/숨김)</li>
