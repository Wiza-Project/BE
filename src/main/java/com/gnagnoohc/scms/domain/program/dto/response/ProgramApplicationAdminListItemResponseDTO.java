...
public record ProgramApplicationAdminListItemResponseDTO(
    ...
    public static ProgramApplicationAdminListItemResponseDTO from(ProgramApplication a) {
        ApplicationStatus status = ApplicationStatus.valueOf(a.getApplicationStatus());
        return new ProgramApplicationAdminListItemResponseDTO(
                a.getApplicationId(),
