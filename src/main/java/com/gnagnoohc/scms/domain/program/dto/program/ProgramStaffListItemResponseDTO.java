...
public record ProgramStaffListItemResponseDTO(
        Integer programId,
        String programName,
    ...
    public static ProgramStaffListItemResponseDTO from(ExtracurricularProgram program, long applicantCount,
                                                         boolean editable) {
        return new ProgramStaffListItemResponseDTO(
