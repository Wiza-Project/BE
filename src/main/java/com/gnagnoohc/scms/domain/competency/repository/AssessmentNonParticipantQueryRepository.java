 ...
 *
 * <p>대상자 = STUDENT 중 학적상태 '재학'(AssessmentTargetPolicy.ENROLLED_STUDENT). 응시율
 * (AssessmentAttendanceQueryRepository)·결과 통계(AssessmentDistributionQueryRepository)와 같은
 * 모수를 쓰도록 조건을 맞춘다.
 */
@Repository
